...
<nav aria-label="breadcrumb" class="main-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Dashboard Gosac</li>
  </ol>
</nav>
...
function initEstadisticas(start, end) {
    ...
    //fetchDataAndProcess('./gosaccontroller/area_categoria_gosac', fetchData, llenarTabla);

    fetchDataAndProcess('./gosaccontroller/area_categoria_gosac', fetchData, data => {
        llenarTabla(data);
        toggleLoader(false);
    });


    fetchDataAndProcess('./gosaccontroller/obtenerVentas', fetchData, data => {
