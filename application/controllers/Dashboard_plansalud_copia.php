...
class Dashboard_plansalud_copia extends CI_Controller {
    ...
    function __construct() {
        ...
        public function index() {
            ...
            $this->load->view($data['mensaje'] ? 'error_view' : 'dashboard_plansalud_copia', $data);
        ...
        public function population() {
            ...
            $sql = "
            SELECT p.calle2, s.nombre AS sede, COUNT(*) AS total
            FROM direcciones2 p
            INNER JOIN clientes2 c ON p.patient_id = c.patient_id
            INNER JOIN sedes s ON p.tenant_id = s.TenantId
            WHERE p.calle2 != ''
            GROUP BY p.calle2, s.nombre
            limit 50
            ";
