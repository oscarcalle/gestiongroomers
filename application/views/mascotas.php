<main class="page-content">
    <div class="container-fluid">
        ...
        <h3 class="mt-2"><i class="fa fa-paw"></i> Mascotas</h3>
    ...
    <script>
        ...
        const columns = [
            ...
            "render": function (data, type, row) {
                return '<a href="./mascotas/' + data + '" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>';
                },
                "orderable": false
            }
        ];
