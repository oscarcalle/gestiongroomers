<main class="page-content">
    <div class="container-fluid">
        ...
        <h3 class="mt-2"><i class="fa fa-map-marker-alt"></i> Direcciones</h3>
    ...
    <script>
        ...
        const initDatatable = () => {
            ...
            { data: "address_id", title: "ID Dirección" },
            { data: "calle1", title: "Calle 1" },
            { data: "calle2", title: "Calle 2" },
            ...
            { data: "sede", title: "Sede" },
            {
                ...
                "render": function (data, type, row) {
                    return '<a href="./direcciones/' + data + '" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>';
                },
                "orderable": false
            }
        ];
