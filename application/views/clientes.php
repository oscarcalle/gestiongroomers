<main class="page-content">
    <div class="container-fluid">
        ...
        <h3 class="mt-2"><i class="fa fa-user"></i> Clientes</h3>
        ...
        <div class="row">
            ...
            <ul class="list-group" id="tipoConsultaList">
                ...
                $opciones = [
                "" => "Todos",
                "unicos" => "Identificaciones Únicas",
                "duplicados" => "Identificaciones Repetidas en 2 o más Sedes",
                ...
                "sin_movil" => "Sin Móvil",
                "sin_fijo" => "Sin Fijo",
                "con_nombre_sin_apellido" => "Con Nombre y Sin Apellido",
                "sin_nombre_con_apellido" => "Sin Nombre y Con Apellido",
                "letras_en_movil" => "Letras en Móvil",
                "email_incorrecto" => "Email Incorrecto",
                "celular_incorrecto" => "Celular Incorrecto"
                ];
    ...
    <script>
        ...
        const columns = [
            ...
            { data: "movil", title: "Móvil" },
            { data: "fijo", title: "Fijo" },
            { data: "sede", title: "Sede" },
            {
            "data": "patient_id",
            "title": "Opciones",
            "render": function (data, type, row) {
                return '<a href="./clientes/' + data + '" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>';
                },
                "orderable": false
            }
        ];
