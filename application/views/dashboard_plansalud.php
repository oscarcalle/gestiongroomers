  ...
  <div class="container-fluid mb-5">
    ...
    <div class="header">
      <div class="d-flex align-items-center justify-content-between flex-nowrap">
        ...
        <div class="d-flex align-items-center">
          <h1 class="mb-0">Planes de Salud</h1>
        </div>
        <!-- Tabs y botones -->
        <div class="d-flex align-items-center">
                ...
                <div class="col-md-6">
                    <div class="card card-inverse card-success">
                        <div class="card-block bg-success">
                            ...
                            <h6 class="text-uppercase">Vigentes</h6>
                            <h1 class="display-1"><?php echo $cantidad_planes_vigentes; ?></h1>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card card-inverse card-danger">
                        <div class="card-block bg-danger">
                            ...
                            <h6 class="text-uppercase">Vencidos</h6>
                            <h1 class="display-1"><?php echo $cantidad_planes_vencidos; ?></h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="card card-inverse card-warning">
                        <div class="card-block bg-warning">
                            ...
                            <h6 class="text-uppercase">Sin Renovar</h6>
                            <h1 class="display-1"><?php echo $cantidad_planes_no_renovados; ?></h1>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card card-inverse card-info">
                        <div class="card-block bg-info">
                            ...
                            <h6 class="text-uppercase">Por Vencer</h6>
                            <h1 class="display-1"><?php echo $cantidad_planes_por_vencer; ?></h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="card card-inverse card-primary">
                        <div class="card-block bg-primary">
                            ...
                            <h6 class="text-uppercase">Planes Nuevos</h6>
                            <h1 class="display-1"><?php echo $cantidad_planes_nuevos; ?></h1>
                        </div>
                    </div>
                </div>
            </div>
          ...
          <div class="card-body">
            <div class="regiones">
              ...
              >
                ...
                <a
                  xlink:title="Pucusana"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Pucusana"
                  target="blanck"
                >
                  <g id="Pucusana">
                    <path
                ...
                <a
                  xlink:title="Santa María del Mar"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Santa_Mar%C3%ADa_del_Mar"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="San Bartolo"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_San_Bartolo"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Punta Negra"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Punta_Negra"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Punta Hermosa"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Punta_Hermosa"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Cieneguilla"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Cieneguilla"
                  target="blanck"
                >
                  <g id="Cieneguilla">
                    <path
                ...
                <a
                  xlink:title="Pachacámac"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Pachac%C3%A1mac"
                  target="blanck"
                >
                  <g id="Pachacamac">
                    <path
                ...
                <a
                  xlink:title="Lurín"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Lur%C3%ADn"
                  target="blanck"
                >
                  <g id="Lurin">
                    <path
                ...
                <a
                  xlink:title="Villa María del Triunfo"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Villa_Mar%C3%ADa_del_Triunfo"
                  target="blanck"
                >
                  <g
                ...
                <a
                  xlink:title="Villa el Salvador"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Villa_El_Salvador"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Chorrillos"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Chorrillos"
                  target="blanck"
                >
                  <g id="Chorrillos">
                    <path
                ...
                <a
                  xlink:title="San Juan de Miraflores"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_San_Juan_de_Miraflores"
                  target="blanck"
                >
                  <g id="SJM">
                    <path
                ...
                <a
                  xlink:title="La Molina"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_La_Molina"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Santiago de Surco"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Santiago_de_Surco"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Barranco"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Barranco"
                  target="blanck"
                >
                  <g id="Barranco">
                    <path
                ...
                <a
                  xlink:title="Surquillo"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Surquillo"
                  target="blanck"
                >
                  <g id="Surquillo">
                    <path
                ...
                <a
                  xlink:title="Miraflores"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Miraflores_(Lima)"
                  target="blanck"
                >
                  <g id="Miraflores">
                    <path
                ...
                <a
                  xlink:title="San Isidro"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_San_Isidro_(Lima)"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="San Borja"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_San_Borja"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="San Luis"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_San_Luis"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="La Victoria"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_La_Victoria"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Lince"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Lince"
                  target="blanck"
                >
                  <g id="Lince">
                    <path
                ...
                <a
                  xlink:title="Jesús María"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Jes%C3%BAs_Mar%C3%ADa"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Magdalena del mar"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Magdalena_del_Mar"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="San Miguel"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_San_Miguel_(Lima)"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Pueblo Libre"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Pueblo_Libre"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Breña"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Bre%C3%B1a"
                  target="blanck"
                >
                  <g id="Breña">
                    <path
                ...
                <a
                  xlink:title="Lima"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Lima"
                  target="blanck"
                >
                  <g id="Lima">
                    <path
                ...
                <a
                  xlink:title="El Agustino"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_El_Agustino"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Santa Anita"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Santa_Anita"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Ate"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Ate"
                  target="blanck"
                >
                  <g id="Ate">
                    <path
                ...
                <a
                  xlink:title="Chaclacayo"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Chaclacayo"
                  target="blanck"
                >
                  <g id="Chaclacayo">
                    <path
                ...
                <a
                  xlink:title="Lurigancho"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Lurigancho-Chosica"
                  target="blanck"
                >
                  <g id="Lurigancho">
                    <path
                ...
                <a
                  xlink:title="Rímac"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_R%C3%ADmac"
                  target="blanck"
                >
                  <g id="Rimac">
                    <path
                ...
                <a
                  xlink:title="Independencia"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Independencia_(Lima)"
                  target="blanck"
                >
                  <g id="Independencia">
                    <path
                ...
                <a
                  xlink:title="Los olivos"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Los_Olivos"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Comas"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Comas"
                  target="blanck"
                >
                  <g id="Comas">
                    <path
                ...
                <a
                  xlink:title="Puente Piedra"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Puente_Piedra"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="San Juan de Lurigancho"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_San_Juan_de_Lurigancho"
                  target="blanck"
                >
                  <g id="SJL">
                    <path
                ...
                <a
                  xlink:title="Carabayllo"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Carabayllo"
                  target="blanck"
                >
                  <g id="Carabayllo">
                    <path
                ...
                <a
                  xlink:title="San Martín de Porres"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_San_Mart%C3%ADn_de_Porres"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Ancón"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Anc%C3%B3n"
                  target="blanck"
                >
                  <g id="Ancon">
                    <path
                ...
                <a
                  xlink:title="Santa Rosa"
                  xlink:href="https://es.wikipedia.org/wiki/Distrito_de_Santa_Rosa_(Lima)"
                  target="blanck"
                >
                ...
                <a
                  xlink:title="Callao"
                  xlink:href="https://es.wikipedia.org/wiki/Provincia_constitucional_del_Callao"
                  target="blanck"
                >
                  <g id="Callao">
                    <path
          ...
          <div class="card-body">
            <div class="icon">
              <div class="dog">
                ...
                <p>
                  Perros: <span id="dog-count">60</span> (<span id="dog-percent"
                    >60%</span
                  >)
                </p>
              </div>
              <div class="cat">
                <span style="font-size: 64px">&#x1F408;</span>
                <p>
                  Gatos: <span id="cat-count">40</span> (<span id="cat-percent"
                    >40%</span
                  >)
                </p>
              </div>
            ...
            <div class="bar-container">
              <div id="dog-bar" class="bar dog-bar" style="width: 60%">
                <span>60%</span>
              </div>
              <div id="cat-bar" class="bar cat-bar" style="width: 40%">
                <span>40%</span>
              </div>
            </div>
          </div>
    ...
    <div class="row g-3 mt-3">
      ...
      <div class="col-md-3">
        <div class="card">
          <div class="card-header">title</div>
          <div class="card-body">Gráfico</div>
        </div>
      </div>
    </div>
  </div>
...
<script>
  $(document).ready(function () {
    ...
    // Inicializar y actualizar texto de los selectpickers
    ["sedesSelect", "areasSelect", "turnosSelect", "diasSelect"].forEach((id) => {
